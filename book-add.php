...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into `books` (ID,BookName,Description,Language,Available,PDF,author,pageNum,dop,image,CatagoryNo) values('','$bookName','$des','$lang','$available','$rowpdf','$author','$pageno','$dop','$rowimg','$categoryNo')";
